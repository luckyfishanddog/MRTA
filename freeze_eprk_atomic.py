...
def main() -> None:
    ...
    development_protocol_hash = sha256_file(ROOT / "EPRK_MA_DEVELOPMENT_PROTOCOL.json")
    freeze_manifest = {
    ...
    normalization_hash = sha256_file(ROOT / "atomic_normalization_spec.json")
    ...
    model_manifest = {
        ...
        "frozen_file_hashes": {name: sha256_file(ROOT / name) for name in model_files},
    }
