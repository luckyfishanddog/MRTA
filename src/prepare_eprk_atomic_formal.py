...
def collision_policy() -> tuple[dict[str, Any], str]:
    policy = {
        ...
        "collision_model_source_sha256": sha256_file(resolve_project_path("collision_aware_schedule.py")),
        "motion_model_source": "MRTA_GA_ACO.py",
        "motion_model_source_sha256": sha256_file(resolve_project_path("MRTA_GA_ACO.py")),
        "required_outputs": [
            "raw_makespan",
...
def draft_protocol() -> dict[str, Any]:
    ...
    return {
        ...
        "legacy_protocol_sha256": sha256_file(resolve_project_path("UNIFIED_EXPERIMENT_PROTOCOL.json")),
        "legacy_manifest_path": "formal_experiment_manifest.json",
        "legacy_manifest_sha256": sha256_file(resolve_project_path("formal_experiment_manifest.json")),
        ...
        "algorithms": {
            ...
            "hga_atomic": {
                ...
                "implementation_sha256": sha256_file(resolve_project_path("MRTA_HGA_ATOMIC_CONTROL.py")),
        ...
        for seed in protocol["seeds"]["formal_paired"]:
            for mode in protocol["execution"]["modes"]:
                ...
                for pair_position, solver in enumerate(solver_order, 1):
                    ...
                    command = [
                        "python", "src/run_eprk_atomic_formal.py", "execute", "--run-id", run_id,
                    ]
